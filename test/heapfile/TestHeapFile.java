...
public class TestHeapFile {
	...
	void TestInsert( HeapFile hp ) throws IOException{
		...
		hp.insert( new IntKey(80), new StringData(maxStringLength, "George"));
		hp.insert( new IntKey(90), new StringData(maxStringLength, "Tom"));
		hp.insert( new IntKey(100), new StringData(maxStringLength, "Jack"));		
		hp.insert( new IntKey(110), new StringData(maxStringLength, "George"));
		hp.insert( new IntKey(120), new StringData(maxStringLength, "Tom"));
		hp.insert( new IntKey(130), new StringData(maxStringLength, "Jack"));		
	}
